    ...
    <div className="flex flex-wrap items-center gap-2">
      ...
      {canTakedown ? (
        <ActionPopover
          ...
          caveat="A takedown cannot un-publish a post already sent to a platform — Spanly only relays content. Already-published targets stay live; remove them from the platform directly."
