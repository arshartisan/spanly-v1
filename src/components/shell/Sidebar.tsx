...
const ADMIN_NAV_ITEM: NavItem = { label: "Admin", href: "/admin", icon: ShieldCheck };
...
export function Sidebar({ user, planLabel, isStaff }: SidebarProps) {
      ...
      <nav className="flex-1 overflow-y-auto px-3 pb-3">
        ...
        {isStaff && (
          <div className="mt-4">
            ...
            <NavLink item={ADMIN_NAV_ITEM} active={isActive(ADMIN_NAV_ITEM.href)} />
          </div>
        )}
      </nav>
