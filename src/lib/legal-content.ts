 ...
 * LinkedIn, TikTok, YouTube, X), our real billing (Stripe), our real 7-day free trial and
  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        {
          type: "p",
          text: `We may offer a ${LEGAL.trialDays}-day free trial that does not require a payment card up front. During the trial you can use the features of the applicable plan. We may change or withdraw trial offers at any time, and trials are limited to one per customer unless we state otherwise.`,
        },
        {
          type: "p",
          text: "At the end of the trial, your access to paid features ends unless you subscribe to a paid plan. We will not charge you automatically when a no-card trial ends.",
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        {
          type: "p",
          text: "Payments are processed by our third-party payment processor, Stripe. By subscribing you authorize us, through Stripe, to charge your chosen payment method the recurring fee for your plan (monthly or annually, as selected), plus applicable taxes, until you cancel.",
        },
        {
          type: "ul",
          items: [
        ...
        {
          type: "p",
          text: "We do not store your full payment card details; they are handled directly by Stripe under its own terms and security standards.",
        },
      ],
    },
    {
  ...
  sections: [
    {
      ...
      blocks: [
        ...
        {
          type: "p",
          text: "When you subscribe, payments are processed by Stripe. We do not receive or store your full card number. We store billing-related metadata such as your plan, subscription status, billing period, and limited identifiers (for example, the last four digits of a card or a Stripe customer ID) needed to manage your subscription.",
        },
      ...
      blocks: [
        { type: "p", text: "We share personal information only as described here:" },
        {
          ...
          items: [
            ...
            "Service providers (subprocessors): trusted vendors who process data on our behalf to run the Service - including Stripe (payments), our email provider, our hosting and storage providers, and error-monitoring tools - under contracts that limit their use of your data.",
