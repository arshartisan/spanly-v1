...
| Payments | **PayPal** (Subscriptions API + webhooks) | Plans, trial, refund; see `10`. |
...
```
   ...
   Billing: PayPal subscription approval ; webhooks → /api/webhooks/paypal.
```
...
# PayPal
BILLING_MODE=mock            # mock | live
PAYPAL_ENV=sandbox           # sandbox | live
PAYPAL_CLIENT_ID=...
PAYPAL_CLIENT_SECRET=...
PAYPAL_WEBHOOK_ID=...
PAYPAL_PLAN_CREATOR_MONTH=P-...
PAYPAL_PLAN_CREATOR_YEAR=P-...
PAYPAL_PLAN_GROWTH_MONTH=P-...
PAYPAL_PLAN_GROWTH_YEAR=P-...
PAYPAL_PLAN_PRO_MONTH=P-...
PAYPAL_PLAN_PRO_YEAR=P-...
PAYPAL_PLAN_API_ADDON=P-...
